...
#p <- spTransform(jc, CRS("+init=epsg:3414"))
...
#colnames(jc_df)[5] <- "X"
#colnames(jc_df)[6] <- "Y"
#jc_df$X <- coordinates_val[,1]
#jc_df$Y <- coordinates_val[,2]
...
#write.csv(jc,'app/data/aspatial/jc2.csv')

#dp_a_jc = paste(dp_a_prefix, "jc2.csv", sep="")
